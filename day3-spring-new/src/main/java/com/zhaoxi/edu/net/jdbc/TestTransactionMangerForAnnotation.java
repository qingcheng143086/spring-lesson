...
/**
 * 测试Spring中对象事务使用注解方式管理
 */
public class TestTransactionMangerForAnnotation {
    public static void main(String[] args) {
        ApplicationContext context =
                new ClassPathXmlApplicationContext("jdbc/spring-tx-annotation.xml");
        OrderService orderService = context.getBean("orderService", OrderService.class);
        // 创建订单对象
        Order order = new Order();
        order.setOrderId(2010111);
